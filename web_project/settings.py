...
SECRET_KEY = '2za9_*(3nz&*k%t+*e8e=xfbjxg@qn5a0o2c9gvl7)j4=^9-q!'
...
DATABASES = {
    "default": {
        ...
        'USER': 'admin',
        'PASSWORD': 'admin',
        'HOST': settings.central_db_host,  # Empty for localhost through domain sockets or           '127.0.0.1' for localhost through TCP.
