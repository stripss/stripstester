    ...
    def print_sticker(self, test_status):
        ...
        if "LINO" in strips_tester.data['program'][1]:  # LINO Product - stickers 38x13mm
            ...
            label_pcb = (
                ...
                'Dy2-me-dd\n'
                'Th:m:s\n'
                'AB,5,4,1,1,0,0E,LINO {color} {length}\n'
                'Lo,0,30,152,31\n'
                'AA,8,41,1,1,0,0E,Rated power: {power}\n'
                'AA,8,60,1,1,0,0E,Input: 24Vdc\n'
                'AA,8,79,1,1,0,0E,CCT: {cct}\n'
            ...
            label_pcb = (
                ...
                'AA,82,1,1,1,0,0E,LED_U24_88\n'
                'AA,82,20,1,1,0,0E,{liebcode}\n'
                'AA,82,39,1,1,0,0E,{date}/{serial}\n'
                'E\n').format(date=date_week,liebcode=strips_tester.data['program'][2],serial=serial)
            ...
            label_profile = (
                ...
                'XRB29,4,3,0,15\n'
                '{liebcode} {date}\n'
                'AA,90,10,1,1,0,0E,{liebcode}\n'
                'AA,90,29,1,1,0,0E,{date}/{serial}\n'
                'E\n').format(date=date_week,liebcode=strips_tester.data['program'][2],serial=serial)
