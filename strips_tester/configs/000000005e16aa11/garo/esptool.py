...
class ESPLoader(object):
    ...
    def __init__(self, config, baud=ESP_ROM_BAUD):
    ...
    @staticmethod
    def detect_chip(config, baud=ESP_ROM_BAUD, connect_mode='default_reset'):
        ...
        detect_port = ESPLoader(config, baud)
